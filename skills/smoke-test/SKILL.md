...
- [ ] **Unresolved exact cleanup IDs remain in a mode-`0600` atomic `/tmp` manifest.** Failure JSON reports only `cleanup_manifest_path`; verified cleanup removes the file.
