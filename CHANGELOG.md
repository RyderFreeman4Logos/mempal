...
- **CLI content writes/search**: retry pin, unpin, and delete SQLite write locks
  for 10 seconds; enforce a 120-second search deadline, including embedder initialization (#831).
