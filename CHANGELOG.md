...
- Ingress: fsync before ACK and claim rename; lease-fenced exactly-once replay; REST bind and systemd READY=1 precede daemon-ready (#945). Persist/spool before model and on SQLite/breaker-open; stall keeps REST (#986, #1000, #987).
