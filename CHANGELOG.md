...
- **Daemon/MCP/CLI coexistence**: open schemas beside live MCP writers; skip bootstrap queue reclaim; retry SQLite stalls; bound writer-lease contention; reclaim dead `sqlite-writer` holders by birth/ns liveness (fail-closed if unverifiable); keep schema reject/repair, query-only reads, durable receipts, bounded drains; fixtures cover timing/leases (#843, #849, #850, #853, #856, #858, #859, #869). Hermes SessionEnd ingest uses indexed SQL session filters (#864).
