...
- Daemon pidfile checks argv/DB/birth before signaling; timed-out scoped ingest claim release retries SQLite locks via `CLAIM_LOCK_RETRY_DEADLINE`, not `Duration::ZERO` (#885/#895).
