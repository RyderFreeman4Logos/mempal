...
- **Hermes plugin read probes**: an open REST breaker still probes `mempal_search` and `mempal_profile`, returning typed/redacted results instead of generic temporary-unavailable errors (#927).
