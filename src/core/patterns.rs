...
#[path = "pattern_detection.rs"]
pub(crate) mod detection;
pub use detection::{PatternDetectionArgs, run_pattern_detection};
pub(crate) use detection::{apply_pattern_detection, plan_pattern_detection};
